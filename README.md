...
- bugrap-addon: addon module, custom server and client side code 
- bugrap-ui: main application module
- bugrap-backend: backend module, contains any server side java code and dependencies
